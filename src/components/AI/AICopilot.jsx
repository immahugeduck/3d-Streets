...
import { sendCopilotMessage } from '../../services/anthropicService'
...
export default function AICopilot() {
  ...
  async function send(text) {
    ...
    if (!reply) {
      addMessage({ role: 'assistant', content: "Sorry, I couldn't connect right now. Check your API key in .env" })
      return
    }
